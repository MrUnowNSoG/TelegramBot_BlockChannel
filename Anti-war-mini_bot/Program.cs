    ...
    class Program {
        ...
        private static void Save() {
            ...
            for (int i = 0; i < all_Force.Count; i++) {
                using (var sw = new StreamWriter("BaseData/force/name/" + i.ToString() + ".txt", false, encoding: System.Text.Encoding.UTF8)) {
                    sw.WriteLine(all_Force[i].ForceMain);
                }

                using (var sw = new StreamWriter("BaseData/force/comments/" + i.ToString() + ".txt", false, encoding: System.Text.Encoding.UTF8)) {
                    sw.WriteLine(all_Force[i].Commentar);
                }

                using (var sw = new StreamWriter("BaseData/force/info/" + i.ToString() + ".txt", false, encoding: System.Text.Encoding.UTF8)) {
        ...
        private static void Download() {
            ...
            for (int i = 0; i < countForce; i++) {
                ...
                using (var sr = new StreamReader("BaseData/force/name/" + i.ToString() + ".txt", encoding: System.Text.Encoding.UTF8)) {
                    temp_f.ForceMain = sr.ReadToEnd();
                }

                using (var sr = new StreamReader("BaseData/force/comments/" + i.ToString() + ".txt", encoding: System.Text.Encoding.UTF8)) {
                    temp_f.Commentar = sr.ReadToEnd();
                }

                using (var sr = new StreamReader("BaseData/force/info/" + i.ToString() + ".txt", encoding: System.Text.Encoding.UTF8)) {
